...
\noindent pop():
\begin{itemize}
\item output: \wss{What should go here?}$S := S[0..|s| - 2]$
...
\hhline{|-|-|}
$c = \mbox{Deck}$& \wss{What goes here?}valid\_tab\_deck($n_0$,$n_1$)\\
\hhline{|-|-|}
$c = \mbox{Waste}$ & \wss{What goes here?}valid\_tab\_waste($n_0$,$n_1$)\\
\hhline{|-|-|}
\end{tabular}
...
\hhline{|-|-|}
$c = \mbox{Deck}$& \wss{What goes here?}valid\_waste\_deck($n$)\\
\hhline{|-|-|}
$c = \mbox{Waste}$ & \wss{What goes here?}valid\_waste\_waste($n$)\\
\hhline{|-|-|}
\end{tabular}
